function IconButton({ variant = "soft", size = "md", className = "", children, ...rest }) {
  const sizes = {
    sm: "h-9 w-9",
    md: "h-11 w-11",
    lg: "h-12 w-12",
  ...
  const variants = {
    soft: "group relative border border-ink-200 bg-white text-ink-600 hover:bg-ink-100 hover:text-brand-600 active:scale-95 dark:border-ink-700 dark:bg-ink-800 dark:text-ink-200 dark:hover:bg-ink-700 dark:hover:text-brand-300",
