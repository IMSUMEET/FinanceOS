...
const navItems = [
  ...
  { to: "/spend-analyzer", label: "Spend Analyzer", emoji: "📊" },
];

export default function AppShell() {
  const location = useLocation();
  const wideContent = location.pathname.startsWith("/spend-analyzer");
      ...
      <div className="relative flex min-h-screen">
        ...
        <main className="flex-1">
          ...
          <div className="p-8">
            <div
              className={
                wideContent ? "mx-auto w-full max-w-none" : "mx-auto max-w-7xl"
              }
            >
              <Outlet />
            </div>
